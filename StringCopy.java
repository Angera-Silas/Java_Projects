public class StringCopy {
    public static void main(String[] args) {
        ...
        System.out.println("Returned String "+str2.matches("java(.*)"));
        System.out.println("Returned String "+str2.matches("(.*)java(.*)"));
        System.out.println("Returned String "+str2.startsWith("welcome"));
        System.out.println("Returned String "+str2.toUpperCase());
        System.out.println("Returned String "+str2.toLowerCase());
        System.out.println("Returned String "+str2.trim());
    }
}
