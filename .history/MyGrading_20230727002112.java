...
public class MyGrading extends MainExam {
    ...
    public void displayGrade() {
        ...
        if (examscore >= 70) {
            System.out.println("Average: "+examscore+"Grade: "+"A");
        } else if (examscore >= 60) {
            System.out.println("Average: "+examscore+"Grade: "+"B");
        } else if (examscore >= 50) {
            System.out.println("Average: "+examscore+"Grade: "+"C");
        } else if (examscore >= 40) {
            System.out.println("Average: "+examscore+"Grade: "+"D");
        } else {
            System.out.println("Average: "+examscore+" Grade: "+"F");
        }
    }
