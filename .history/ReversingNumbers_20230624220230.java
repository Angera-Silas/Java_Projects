...
public class ReversingNumbers {
    public static void main(String[] args) {
        ...
        int num;
        int reversednums = 0;
        System.out.println("Enter anumber to be displayed in reverse order");
        num = in.nextInt();
        while(num!=0){
            ...
            * it becomes the tenth and then it will move to hundredth ......then it moves up to the largest
            * place value the number have */
            num/=10;/* we divide num by 10 to eliminate the last digit */
        }
